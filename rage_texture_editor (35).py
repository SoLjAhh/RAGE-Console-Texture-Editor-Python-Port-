...
class TextureDict:
    ...
    def save(self, out_path):
        ...
        if gpu_grew:
            # The conversion rebuilt the GPU block with the RAGE page allocator,
            # which produced an exact, self-consistent graphics page-flag. Write
            # that flag into the header so the loader's GetValueRSC7 matches the
            # real segment size and the BlockMap resolves correctly.
            ...
            # header: '7CSR'(4) ver(4) sysFlag(4 LE-of-BE) gfxFlag(4 LE-of-BE)
...
class App(tk.Tk):
    ...
    def _convert_format_sel(self):
        ...
        for f in ("DXT5","DXT3","DXT1","8_8_8_8"):
